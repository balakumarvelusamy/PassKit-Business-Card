                            ...
                            {passes.map((pass) => (
                                <div key={pass.key} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem", background: "var(--background)", borderRadius: "12px", border: "1px solid var(--border)", flexWrap: "wrap", gap: "1rem" }}>
                                    ...
                                    <div style={{ display: "flex", gap: "0.75rem" }}>
                                        <a href={pass.url} target="_blank" rel="noopener noreferrer" title="Download Pass" style={{ padding: "0.5rem", background: "var(--foreground)", color: "var(--background)", borderRadius: "8px", textDecoration: "none", fontWeight: 600, fontSize: "0.85rem", display: "flex", alignItems: "center", justifyContent: "center" }}>
