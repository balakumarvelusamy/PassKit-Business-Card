                            ...
                            {passes.map((pass) => (
                                <div key={pass.key} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem", background: "var(--background)", borderRadius: "12px", border: "1px solid var(--border)", flexWrap: "wrap", gap: "1rem" }}>
                                    ...
                                    <div style={{ display: "flex", gap: "0.75rem" }}>
                                        <button onClick={() => handleDownload(pass.url, pass.key.split('/').pop() || 'pass.pkpass')} title="Download Pass" style={{ padding: "0.5rem", background: "var(--foreground)", color: "var(--background)", borderRadius: "8px", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
